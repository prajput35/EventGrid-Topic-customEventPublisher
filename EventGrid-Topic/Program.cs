...
namespace EventGrid_Topic
{
    class Program
    {
        static string _endpoint = "https://apptopic3000.centralindia-1.eventgrid.azure.net/api/events";
        static string _key = "k9+0L6AWWHN6mc3gXfqtu/Xt/Rv2k3hzEw/CGECN2lk=";
